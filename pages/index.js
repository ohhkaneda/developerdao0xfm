      ...
      <FullScreen handle={screenMood}>
        <main className={styles.main}>
            ...
            <div className="container">
              <div className="header_container">
                <div className="logo">
                  ...
                  <span className="0xfm_live"></span>
                </div>
                <div className="headIcons">
                  <div
                    className="full_screen_button icons"
                    onClick={screenMood.enter}
                    title="Full Screen"
                  >
                    <Image src={OpenfullScreen} alt="full Screen Icon" />
                  </div>
                  <div
                    className="close_full_screen_button icons"
                    onClick={screenMood.exit}
                  ...
                  <div className="icons" title="tweet">
                    <a
                      href="https://twitter.com/intent/tweet?text=Dancing to 🎧 Synthwave Music on Developer DAO 0xFM https://www.developerdao0xfm.vercel.app/"
                      rel="noreferrer"
                      target="_blank"
                    >
          ...
          <div className="anmation">
            <div className="face_background"></div>
